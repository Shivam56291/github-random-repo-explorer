...
- 🔎 **GitHub Repository Explorer** — Search users and discover random public repositories with detailed stats.
- 👤 **Profile Analyzer** — View GitHub user information including followers, repositories, and account data.
- 📈 **Coding Progress Tracker** — Track daily solved problems with automatic streak calculation and weekly progress view.
- ⏱ **Focus Mode (Pomodoro Timer)** — Adjustable focus sessions, break timer, and developer motivational quotes.
- 💾 **Local Persistence** — Data stored locally using AsyncStorage.
- 🎨 **Premium UI & Animations** — Smooth transitions, micro-interactions, and clean card-based mobile design.
...
<p align="center">
  <img src="./assets/Screenshot_1773336204.png" width="220"/>
</p>
